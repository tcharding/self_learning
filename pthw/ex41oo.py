...
#        print('insert quip here')
    ...
    def gold_koi_pond(self):
        ...
        print("You walk close and see a missive fin poke out.")
        print("You peek in a a creepy looking huge Koi stares at you.")
        ...
        if feed_it == "feed it":
            ...
            print("then it *lunges* out of the water, up in te air and over your")
            print("entire body, cake and all.")
            print("Your are then pooed out a week later.")
            return 'death'

        elif feed_it == "throw it in":
            print("The Koi wiggles, then leaps into the air to eat the cake.")
            print("You can see it's happy, it then grunt, thrashes...")
            print("and finally  rolls over and ppos a magic diamond into the air.")
            print("at your feet")

        else:
            print("The Koi gets annoyed and wiggle a bit.")
            return 'gold_koi_pond'

    def bear_with_sword(self):
        print("Puzzled, you are about to pick up the fish poo diamond when")
        print("a bear bearing a load bearing sword walks in.")
        print('"Hey! That\'s my diamond! Where\'d you get that!?"')
        print("It holds its paw out and loos at you.")

        give_it = input("> ")
        
        if give_it == "give it":
            print("The bear swipse at you hand to grab the diamond and")
            print("rips your had off in the process. It then looks at")
            print('your bloody stump and sasy, "Oh crap, sorry about that."')
    ...
    def big_iron_gate(self):
        ...
        if open_it == 'open it':
            ...
            print("There are mountain. And berries! And...")
            print("Oh, but then the bear comes with his katana and stabs you.")
            print('"Who\'s laughing now!? Love this katana."')
            return 'death'
        else:
            print("That does not seem sensible. I mean, the door's right there.")
            return 'big_iron_gate'
